...
let modules = {
        ...
        operate_overview: {
            url: "operate_overview.html",
            pageName: "经营概况",
            hash: "operate_overview",
        ...
        present_purchase: {
            url: "present_purchase.html",
            pageName: "礼品购买",
            hash: "present_purchase",
            icons: "layui-icon-star",
            hasTag: false,
            isMenu: true
        },
        manage_present_order: {
            url: "manage_present_order.html",
            pageName: "礼品订单",
            hash: "manage_present_order",
            icons: "layui-icon-list",
            hasTag: false,
            isMenu: true
        },
    ...
    roles = {
        // 管理员
        super: ["home", "operate_overview", "add_money", "task_create", "kb_purchase", "manage_task", "manage_kb_order", "present_purchase", "manage_present_order", "manage_basic_data", "notice_manage", "user_manage", "manage_logs", "money_manage", "account_set", "advice_feedback", "help_center"],
        // 普通用户
        common: ["home", "add_money", "task_create", "kb_purchase", "manage_task", "manage_logs", "manage_kb_order", "present_purchase", "manage_present_order", "advice_feedback", "account_set", "help_center"],
    };
exports.roles = roles;
