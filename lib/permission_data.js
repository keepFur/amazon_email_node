...
let modules = {
    ...
    roles = {
        // 管理员
        super: ["home", "operate_overview", "add_money", "task_create", "kb_purchase", "manage_task", "manage_kb_order", "manage_basic_data", "notice_manage", "user_manage", "manage_logs", "money_manage", "account_set", "advice_feedback", "help_center"],
        // 普通用户
