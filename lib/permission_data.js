...
let modules = {
    ...
    roles = {
        // 管理员
        super: ["home", "add_money", "task_create", "kb_purchase", "manage_task", "manage_kb_order", "manage_basic_data", "notice_manage", "user_manage", "manage_logs", "money_manage", "account_set", "advice_feedback"],
        // 普通用户
        common: ["home", "add_money", "task_create", "kb_purchase", "manage_task", "manage_logs", "manage_kb_order", "advice_feedback", "account_set"],
    };
exports.roles = roles;
