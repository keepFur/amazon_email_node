...
let modules = {
    ...
    roles = {
        // 管理员
        super: ["home", "add_money", "manage_task", "plant_manage", "notice_manage", "user_manage", "task_create", "manage_logs", "money_manage", "task_template", "create_advice_feedback", "manage_advice_feedback"],
        // 普通用户
