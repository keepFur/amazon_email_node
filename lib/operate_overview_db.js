...
OperateOverview.prototype.getTodayData = function() {
    ...
    SELECT COUNT(*) AS todayAddUserCount,SUM(money) AS todayAddUserMoney FROM yidian_user WHERE to_days(created_date) = to_days(now());
...
OperateOverview.prototype.getAllData = function() {
    ...
    SELECT COUNT(*) AS todayAddUserCount,SUM(money) AS todayAddUserMoney FROM yidian_user;
