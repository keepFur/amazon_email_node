...
ManageKbAddress.prototype.createKbAddress = function (data) {
    let cmdText = `INSERT INTO yidian_kb_address (detail,email, contact,phone,user_id,remark,created_date) VALUES(?,?,?,?,?,?,?)`,
        cmdParams = [];
...
ManageKbAddress.prototype.readKbAddress = function (data) {
    let cmdText = `SELECT id, detail,email, contact,phone,remark, created_date AS createdDate,update_date AS updateDate 
