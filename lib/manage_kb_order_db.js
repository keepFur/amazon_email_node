...
KbOrderManage.prototype.createKbOrder = function (data) {
    let cmdText = `INSERT INTO yidian_kb_order
        (number,remark, plant,user_id,kb_number,kb_company, address_from, address_to, address_to_pca, address_from_pca,to_name,to_phone,kb_weight, total,created_date) VALUES `,
        cmdParams = [];
