...
TbTaskDB.prototype.readTaskPage = function(data) {
    let limit = Number(data.limit || 20),
        ...
        task_start_date AS taskStartDate, task_end_date AS taskEndDate,
        task_baby_link_token AS taskBabyLinkToken, task_unit_price AS taskUnitPrice,task_sum_price  AS taskSumMoney,
