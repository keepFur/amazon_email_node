...
TaskTypeManage.prototype.createTaskType = function (data) {
    let cmdText = `INSERT INTO yidian_task_type
        (name,description,plant,in_price,out_price,is_pc,lieliu_code,has_keyword, created_date)
        VALUES (?,?,?,?,?,?,?,?,?)`,
        cmdParams = [];
    ...
    cmdParams.push(data.hasKeyword);
...
TaskTypeManage.prototype.readTaskType = function (data) {
    let cmdText = `SELECT id,name,description,plant, is_pc AS isPc,lieliu_code AS lieliuCode,in_price AS inPrice, out_price AS outPrice, has_keyword AS hasKeyword ,created_date AS createdDate,update_date AS updateDate 
...
TaskTypeManage.prototype.readTaskTypeById = function (data) {
    let cmdText = `SELECT id, name ,description,isPc, plant,lieliuCode,inPrice,outPrice,  has_keyword AS hasKeyword ,created_date AS createdDate,update_date AS updateDate 
