...
ManageKbType.prototype.createKbType = function (req, res, data) {
    DB.dbQuery.KbTypeManage.createKbType(data).then(result => {
        res.send({
...
ManageKbType.prototype.readKbTypePage = function (req, res, data) {
    DB.dbQuery.KbTypeManage.readKbTypePage(data).then(result => {
        res.send({
            success: true,
            message: '',
            data: {
...
ManageKbType.prototype.readKbTypeById = function (req, res, data) {
    DB.dbQuery.KbTypeManage.readKbTypeById(data).then(result => {
        res.send({
            success: true,
            message: '',
            data: {
...
ManageKbType.prototype.updateKbType = function (req, res, data) {
    DB.dbQuery.KbTypeManage.updateKbType(data).then(result => {
        res.send({
            success: result.affectedRows === 1,
            message: ''
        });
...
ManageKbType.prototype.toggleKbType = function (req, res, data) {
    DB.dbQuery.KbTypeManage.toggleKbType(data).then(result => {
        res.send({
            success: result.affectedRows === 1,
            message: ''
        });
