...
layui.use(['util'], function() {
  ...
  var APIUtil = {
    ...
    userKey:
      '2798f6d7d5ae3b2a18e2829d0e5025da#asd12c1e5606f7b40e680d3b5bfc7dbb042ff',
    username: 'u_35a420fd8e3f',
    ...
    signkey: function(apiName, params) {
      ...
      var encodeUlr = encodeURIComponent(
        `${apiName}?${params}&${this.userKey.split('#')[0]}`
      )
    ...
    createTask: function(params, callback) {
      ...
      this.getServerTimestamp(function(data) {
        ...
        params.signkey = _this.signkey(
          '/ll/task_add',
          core.objectToString(params)
        )
