...
flyer.define('user_manage', function(exports, module) {
    ...
    function initEvent() {
        ...
        // 修改用户
        $('.updateUser').on('click', updateUserHandle);
        // 积分充值
    ...
    function createUserHandle(events) {
        flyer.open({
            ...
            btns: [{
                ...
                click: function(ele) {
                    var that = this;
                    var userInfo = core.getFormValues($('form[name=userRegisterForm]'));
                    ...
                    if (validUserInfoResult.isPass) {
                        ...
                        flyer.msg(validUserInfoResult.msg);
                    }
                }
            }, {
                text: '取消',
