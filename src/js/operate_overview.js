    ...
    function getTodayData() {
        $.get('/api/getTodayData', function(res) {
            if (res.success) {
                ...
                $('.js-user-today-add-count').text(data.todayAddUserCount + '个/' + core.fenToYuan(data.todayAddUserMoney || 0) + '元');
    ...
    function getAllData() {
        $.get('/api/getAllData', function(res) {
            if (res.success) {
                ...
                $('.js-user-all-add-count').text(data.allAddUserCount + '个/' + core.fenToYuan(data.allAddUserMoney || 0) + '元');
